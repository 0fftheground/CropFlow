...
> 对齐依据：`docs/planning/archive/P1/plant-protection-closed-loop-schedule.md`、`docs/planning/directions/plant-protection/overview.md`、`docs/planning/team-work-division/frontend.md`、`docs/planning/directions/calendar-stage/overview.md`。
