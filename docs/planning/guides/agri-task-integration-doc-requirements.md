...
> 通用 FDE 工作流程见 `docs/planning/guides/fde-standard-workflow.md`；本文档是农事项接入场景下的专项模板。
...
| 产物 | 建议落点 | FDE 要做什么 |
|---|---|---|
| 方向总纲 | `docs/planning/directions/<direction>/overview.md` | 整理范围、任务类型、职责边界、冻结口径、待决问题 |
| 主链路任务清单 | `docs/planning/directions/<direction>/task-checklist.md` | 按一个个农事项拆清触发、依赖、动作、分支和后续 |
...
| 前端 handoff | `docs/planning/team-work-division/frontend-<direction>-handoff.md` | 页面流程、操作入口和 mock 场景明确后 |
