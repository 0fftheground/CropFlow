...
```text
1. 本文件中的 P0/P1/P2/P3/P4 是为了 session 交接而使用的工作相位切片。
...
| `P4` | `Agent Runtime` | Business Agent Runtime 接入 | 让 Agent 基于真实 CropFlow 状态运行，并建立受控 Action、批准、审计和恢复边界 | `backend_mvp_implemented` |
...
| `P4` | `project-context/phases/phase-4-agent-runtime-integration.md` |
